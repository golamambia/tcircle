...
const [otp, setOTP] = useState('');
 ...
 useFocusEffect(
  React.useCallback(() => {
const encrypt = encryptData('2025');
...
const otpHandler = () => {
   ...
   function verifyOtp(otp){
      ...
      RegistrationService.loginWithOTP(payload)
        .then(res => {
          const result=res.COALBPSOTPRequestResult;
          console.log('COALBPSOTPRequestResult res', JSON.stringify(res));
          setLoadingM(false);
          //setloading(false);
        ...
        <View style={styles.textDiv}>
          ...
          <View style={{width:'100%'}}>
            ...
            <View style={{marginTop:1}}>
              <ButtonNormal onPress={()=>pinST?resetPinHandler():otpHandler()} loading={loading}>
